...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $images = $em->getRepository('CoreBundle:Image')->findAll();
    ...
    {
        $image = new Image();
        $form = $this->createForm('CoreBundle\Form\ImageType', $image);
    ...
    {
        $deleteForm = $this->createDeleteForm($image);
        $editForm = $this->createForm('CoreBundle\Form\ImageType', $image);
